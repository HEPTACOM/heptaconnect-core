...
final class UriToPathConvertingStreamWrapper implements StreamWrapperInterface
{
    ...
    {
        return $this->decorated->dir_opendir($this->converter->convertToPath($path), $options);
    }
    ...
    public function dir_readdir()
    {
        ...
        return $this->converter->convertToUri($result);
    }
    ...
    {
        return $this->decorated->mkdir($this->converter->convertToPath($path), $mode, $options);
    }

    public function rename(string $path_from, string $path_to): bool
    {
        return $this->decorated->rename(
            $this->converter->convertToPath($path_from),
            $this->converter->convertToPath($path_to)
        );
    }

    public function rmdir(string $path, int $options): bool
    {
        return $this->decorated->rmdir($this->converter->convertToPath($path), $options);
    }
    ...
    {
        return $this->decorated->stream_metadata($this->converter->convertToPath($path), $option, $value);
    }

    public function stream_open(string $path, string $mode, int $options, ?string &$opened_path): bool
    {
        // what is opened_path?
        return $this->decorated->stream_open($this->converter->convertToPath($path), $mode, $options, $opened_path);
    }
    ...
    {
        return $this->decorated->unlink($this->converter->convertToPath($path));
    }

    public function url_stat(string $path, int $flags)
    {
        return $this->decorated->url_stat($this->converter->convertToPath($path), $flags);
    }
}
